...
public void createGUI(){
  ...
  carButt = new GButton(window1, 20, 21, 80, 30);
  carButt.setText("Car");
  carButt.addEventHandler(this, "carButtonClicked");
  hbButt = new GButton(window1, 125, 20, 82, 31);
  hbButt.setText("Hatchback");
  hbButt.addEventHandler(this, "hbButtClicked");
  suvButt = new GButton(window1, 19, 63, 80, 30);
  suvButt.setText("SUV");
  suvButt.addEventHandler(this, "suvButtonClicked");
  truckButt = new GButton(window1, 126, 64, 80, 30);
